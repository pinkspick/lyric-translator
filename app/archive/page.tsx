  ...
  return (
    <main style={{paddingBottom: '120px', maxWidth: '800px', margin: '0 auto'}}>
      ...
      <section style={{padding: '96px 24px 32px'}}>
        <span style={{fontFamily: 'Work Sans, sans-serif', fontSize: '11px', textTransform: 'uppercase', letterSpacing: '0.2em', color: '#4d4447', display: 'block', marginBottom: '8px'}}>个人档案</span>
        <h2 style={{fontFamily: 'Newsreader, serif', fontSize: '48px', fontWeight: 700, lineHeight: 1.1, marginBottom: '8px'}}>我的档案</h2>
      ...
      <section style={{padding: '0 24px'}}>
        ...
        {!loading && history.length === 0 && (
          <div style={{textAlign: 'center', padding: '48px 0'}}>
            ...
            <p style={{fontFamily: 'Newsreader, serif', fontStyle: 'italic', fontSize: '20px', color: '#4d4447'}}>档案为空</p>
            <p style={{fontFamily: 'Work Sans, sans-serif', fontSize: '13px', color: '#7f7478', marginTop: '8px'}}>搜索歌曲开始收藏</p>
            ...
            <div key={item.key} style={{
              ...
              <div style={{display: 'flex', alignItems: 'center', gap: '20px', flex: 1}} onClick={() => openSong(item)}>
                <span style={{
                  ...
                  fontSize: '20px', color: '#d0c3c7', fontWeight: 700, minWidth: '32px'
